...
#predict two timesteps into the future
for i in range(2):
    rain_prob_next = probabilities[-1][0] * transition_probs['rain_to_rain'] + probabilities[-1][1] * transition_probs['no_rain_to_rain']
    no_rain_prob_next = probabilities[-1][0] * transition_probs['rain_to_no_rain'] + probabilities[-1][1] * transition_probs['no_rain_to_no_rain']
